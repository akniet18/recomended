...
def complete_view(request):
    return Response({'status': status.HTTP_200_OK, 'msg': _('Email account is activated')})
...
class LoginView(GenericAPIView):
    ...
    def login(self):
        ...
        if getattr(settings, 'REST_USE_JWT', False):
            ...
            self.token = create_token(self.token_model,
                                      self.user,
                                      self.serializer)
...
class LogoutView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return self.finalize_response(request, response=response, *args, **kwargs)
